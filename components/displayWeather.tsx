...
const DisplayWeather: React.FC<WeatherDisplayProps> = ({current, daily, hourly, forecast, city}) => {
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.currentWeatherContainer}>
                <Text style={styles.currentTemp}>{placeName}</Text>
...
const styles = StyleSheet.create({
    ...
    sectionTitle: {
        ...
        color: '#333',
        textAlign: 'center',
        textShadowColor: 'white', // Color of the outline
